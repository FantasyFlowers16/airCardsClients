  ...
  <div class="b-company-card-backdrop">
    <div class="b-company-card">
      ...
      <div class="b-company-card__delete-but-container">
        <q-btn class="b-company-card__delete-but" color="black" @click="deletePas"> Удалить</q-btn>
      </div>
...
export default class CompanyCard extends Vue.with(Props) {
  ...
  updateOpCloseenCard (val: boolean) {
  ...
  closeCard () {
    this.updateOpCloseenCard(false)
  }
}
</script>
<style lang="scss">
...
.b-company-card{
  ...
  &__delete-but{
    ...
    padding: 10px 30px;
    border-radius: 10px;
    font: 700 20px/24px "Comfortaa",sans-serif;
    z-index: 2;
  }
  &__fon{
    content: '';
